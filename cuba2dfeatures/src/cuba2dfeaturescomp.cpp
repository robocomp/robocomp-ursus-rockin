...
class Cuba2DFeaturesComp : public RoboComp::Application
{
private:
...
void Cuba2DFeaturesComp::initialize()
{
...
int Cuba2DFeaturesComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
DifferentialRobotPrx differentialrobot_proxy;
    ...
    while(!cuba2dnaturallandmarks_topic){
		try {
			cuba2dnaturallandmarks_topic = topicManager->create("Cuba2Dnaturallandmarks"); // communicator()->getProperties()->getProperty("Cuba2Dnaturallandmarks") does not work!
		}catch (const IceStorm::TopicExists&){
		  	// Another client created the topic.
			try{
				cuba2dnaturallandmarks_topic = topicManager->retrieve("Cuba2Dnaturallandmarks"); // communicator()->getProperties()->getProperty("Cuba2Dnaturallandmarks") does not work!
			}catch (const IceStorm::NoSuchTopic&){
				//Error. Topic does not exist.	
			}
		}
	}
	Ice::ObjectPrx cuba2dnaturallandmarks_pub = cuba2dnaturallandmarks_topic->getPublisher()->ice_oneway();
	Cuba2DnaturallandmarksPrx cuba2dnaturallandmarks = Cuba2DnaturallandmarksPrx::uncheckedCast(cuba2dnaturallandmarks_pub);
	mprx["Cuba2DnaturallandmarksPub"] = (::IceProxy::Ice::Object*)(&cuba2dnaturallandmarks);
