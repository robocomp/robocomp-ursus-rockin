...
/** \mainpage RoboComp::clientRosRob
 *
 * \section intro_sec Introduction
 *
 * The clientRosRob component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/clientRosRob --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class clientRosRob : public RoboComp::Application
{
public:
	clientRosRob (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::clientRosRob::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
