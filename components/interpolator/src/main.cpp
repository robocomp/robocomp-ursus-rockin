...
/** \mainpage RoboComp::Interpolator
 *
 * \section intro_sec Introduction
 *
 * The Interpolator component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/Interpolator --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class Interpolator : public RoboComp::Application
{
private:
	void initialize();
	MapPrx mprx;
...
int Interpolator::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
