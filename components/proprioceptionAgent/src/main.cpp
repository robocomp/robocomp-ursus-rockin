...
/** \mainpage RoboComp::proprioceptionAgent
 *
 * \section intro_sec Introduction
 *
 * The proprioceptionAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/proprioceptionAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class proprioceptionAgent : public RoboComp::Application
{
public:
	proprioceptionAgent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::proprioceptionAgent::initialize()
{
...
int ::proprioceptionAgent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::proprioceptionAgent app(prefix);
