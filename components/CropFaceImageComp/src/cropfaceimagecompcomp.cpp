...
class CropFaceImageCompComp : public RoboComp::Application
{
private:
...
void CropFaceImageCompComp::initialize()
{
...
int CropFaceImageCompComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
