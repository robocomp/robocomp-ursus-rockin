...
/** \mainpage RoboComp::ikSystemObject
 *
 * \section intro_sec Introduction
 *
 * The ikSystemObject component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/ikSystemObject --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class ikSystemObject : public RoboComp::Application
{
public:
	ikSystemObject (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::ikSystemObject::initialize()
{
...
int ::ikSystemObject::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
