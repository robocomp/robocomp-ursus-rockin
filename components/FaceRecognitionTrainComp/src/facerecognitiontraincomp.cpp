...
class FaceRecognitionTrainComp : public RoboComp::Application
{
private:
...
void FaceRecognitionTrainComp::initialize()
{
...
int FaceRecognitionTrainComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
