...
/** \mainpage RoboComp::reflexxes
 *
 * \section intro_sec Introduction
 *
 * The reflexxes component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/reflexxes --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class reflexxes : public RoboComp::Application
{
public:
	reflexxes (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
