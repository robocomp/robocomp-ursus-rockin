...
/** \mainpage RoboComp::opAgent
 *
 * \section intro_sec Introduction
 *
 * The opAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/opAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class opAgent : public RoboComp::Application
{
public:
	opAgent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::opAgent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
